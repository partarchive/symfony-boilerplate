Symfony 2.0 Biolerplate
=======================

This is a git project that can be taken and turned into a symfony
project with the least ammount of effort.

  - Removes the Acme demo project
  - sets up a reasonable gitignore file
